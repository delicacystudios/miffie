...
module.exports.run = async (client, message, args) => {
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .setDescription(`**Bot Description**\n${client.user.tag} is a multi purpose discord bot with many different commands. I have fun commands, moderation commands, music commands and many more. Use the command \`${guild.prefix}help\` to see my full list of commands.`)
    .addFields(
