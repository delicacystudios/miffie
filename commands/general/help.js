...
.addFields(
    ...
    {name: '**Links**', value: `[**Invite Me**](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot) | [**Support Server**](https://discord.gg/jDdkVRsEsN) | [**Source Code**](https://github.com/brxnson/Multi-Purpose-Discord-Bot)`}
)
...
.addFields(
    ...
    {name: 'Information', value: `For more information on a command do \`${data.Prefix}help <Command Name>\`\nIf you have any query about the bot feel free to join our support server: [**Invite**](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)`}
)
